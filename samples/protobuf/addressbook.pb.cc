...
void protobuf_AddDesc_addressbook_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021addressbook.proto\022\010tutorial\"\311\001\n\006Person"
    "\022\014\n\004name\030\001 \002(\t\022\r\n\005email\030\003 \002(\t\022,\n\006phones\030"
    "\004 \003(\0132\034.tutorial.Person.PhoneNumber\032G\n\013P"
    "honeNumber\022\016\n\006number\030\001 \002(\t\022(\n\004type\030\002 \002(\016"
    "2\032.tutorial.Person.PhoneType\"+\n\tPhoneTyp"
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // required .tutorial.Person.PhoneType type = 2;
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
